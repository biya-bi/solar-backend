...
import org.rainbow.solar.converter.PanelDtoConverter;
...
/**
 * PanelDto Controller for all Rest APIs related to PanelDto.
 * 
 * @author biya-bi
 *
 */
...
public class PanelController {
	...
	public ResponseEntity<?> getAllDailyElectricityFromYesterday(@PathVariable(value = "id") Long id,
		...
		List<DailyElectricity> dailyElectricityForPanel = hourlyElectricityService
				.getDailyElectricitiesBeforeDate(id, LocalDateTime.of(LocalDate.now(), LocalTime.MIDNIGHT), pageable);
